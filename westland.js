// ============================================================
// Pest Radar — Westland forecast (regional prototype)
// Working diffusion + hotspot + cone forecast model, ported
// from the original standalone prototype into the multi-page
// site as an ES module with dark-default theme + EN/NL/ES i18n.
// Static UI labels are owned by data-i18n in westland.html; this
// module writes only dynamic VALUE spans (numbers/IDs/data).
// ============================================================
import { initI18n, onLangChange } from "./i18n.js";

// ---- Theme: default dark, persist, support multiple toggles ----
(function theme() {
  const KEY = "pr-theme";
...
// ---- i18n: mount language switcher + re-render dynamic content on lang change ----
initI18n();
onLangChange(() => render());
